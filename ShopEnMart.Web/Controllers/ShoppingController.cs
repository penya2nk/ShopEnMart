...
namespace ShopEnMart.Controllers
{
    ...
    public class ShoppingController : Controller
    {
        ...
        {
            List<MemberShoppingCartDetails_Result> cd = _unitOfWork.GetRepositoryInstance<MemberShoppingCartDetails_Result>().GetResultBySqlProcedure("MemberShoppingCartDetails @memberId",
